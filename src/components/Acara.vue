...
<template>
  <v-container height="90dvh" class="relative p-0 overflow-hidden">
    ...
    />
    <div class="absolute top-0 left-0 w-full h-full bg-gradient-to-b from-[#A3B18A]/50 to-[#3c442d] py-10">
          ...
          <div class="flex justify-center">
            <div class="w-[70%]">
              <div data-aos="fade-left" data-aos-delay="1000">
                ...
                <div>
                  <div
                    class="flex justify-center items-center gap-3 md:px-10 px-2"
                  >
                    <div class="w-40">
              ...
              <div class="flex justify-center">
                <div
                  class="w-50 flex justify-center"
                  data-aos="zoom-in"
                  data-aos-delay="1000"
                >
                  <v-divider
              ...
              <div data-aos="fade-right" data-aos-delay="1000">
                <div class="p-5 py-2">
                  <v-icon
                    ...
                    color="white"
                  ></v-icon>
                  <h4 class="text-2xl text-white text-nowrap">Resepsi</h4>
                </div>
                <div>
                  <div
                    class="flex justify-center items-center gap-3 md:px-10 px-2"
